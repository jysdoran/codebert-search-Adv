    ...
    for idx in range(args.start_epoch, int(args.num_train_epochs)): 
        ...
        for step, batch in enumerate(bar):
            ...
            if args.synthetic_dataset_strategy == 'paired':
                ...
                code_nl_loss = 0.5 * (BatchContrastiveLoss()(real_code_vec, real_nl_vec, bs // 2)
                                      + BatchContrastiveLoss()(synthetic_code_vec, synthetic_nl_vec, bs // 2))
                real_synth_loss = 0.5 * (BatchContrastiveLoss()(real_code_vec, synthetic_code_vec, bs // 2)
                                         + BatchContrastiveLoss()(real_nl_vec, synthetic_nl_vec, bs // 2))
